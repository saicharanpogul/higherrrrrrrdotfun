  ...
  return (
    <div
      style={{
        ...
        // backgroundImage: "url('/dechargedotnetworkbackground.png')",
      ...
      >
        <div className="flex flex-row items-center justify-center py-20 h-screen md:h-auto relative w-full">
          <div className="max-w-7xl mx-auto w-full relative overflow-hidden h-full md:h-[40rem] px-4">
            <div>
              <h2 className="text-center text-xl md:text-4xl font-bold text-[#22C55E]">
                Campaign for higherrrrrrr.fun by{" "}
                <a
                  className="underline"
        ...
        <div className="fixed top-[50%] w-[90%] lg:w-[50%] left-[50%] z-[1500] translate-x-[-50%] translate-y-[-50%] p-4 md:p-10">
          <Campaign campaignId={4542} displayMode="integrated" />
        </div>
        {/* <img
          src="/ideasdotfun.jpg"
          alt="img"
